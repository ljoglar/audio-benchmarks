...
function selectAudio(e, audioURL) {
    ...
    switch (e.target.id) {
        case "audio5s":
            // window.audioURL = 'https://audio.luisjoglar.com/benchmark/mozart_c_major_5sec.wav';
            window.audioURL = '/audio/mozart_c_major_5sec.wav';
                break;
        case "audio10s":
            // window.audioURL = 'https://audio.luisjoglar.com/benchmark/mozart_c_major_10sec.wav';
            window.audioURL = '/audio/mozart_c_major_10sec.wav';
            break;
        case "audio20s":
            // window.audioURL = 'https://audio.luisjoglar.com/benchmark/mozart_c_major_20sec.wav';
            window.audioURL = '/audio/mozart_c_major_20sec.wav';
            break;
        case "audio30s":
            // window.audioURL = 'https://audio.luisjoglar.com/benchmark/mozart_c_major_30sec.wav';
            window.audioURL = '/audio/mozart_c_major_30sec.wav';
            break;
    }
}
